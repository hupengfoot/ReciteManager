 ...
 */
export function isUndefined(isnum){//校验是否为空以及转化百分比
  // console.log(isnum.rightNum)
  isnum.rightNum = isnum.rightNum?isnum.rightNum:0
  isnum.wrongNum = isnum.wrongNum?isnum.wrongNum:0
  //  console.log(isnum.rightNum)
